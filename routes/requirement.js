...
router.patch("/addrequirement/:projectId", verifyToken, async (req, res, next) => {
	// Validate
...
// Update requirement
router.patch(
	"/updaterequirement/:projectId/:requirementIndex",
	verifyToken,
	async (req, res, next) => {
...
router.get("/getall/:projectId", verifyToken, async (req, res, next) => {
	try {
